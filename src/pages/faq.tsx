      ...
      <div class={daisy("card")({addedClass: wind({boxShadow: "shadow-xl"}).class(), color: "bg-base-100"})}>
        <div class={daisy("card-body")({})}>
          <article class={daisy("prose")({})}>
            ...
            <p>Absolutely! Just be sure to have them complete the <strong>RSVP</strong> form as well so we can have an accurate headcount.</p>
            ...
            <p>Check out our <strong>Travel + Lodging</strong> page for more info on where to stay in Seattle, how to get around, etc.</p>
            <h2>🏙️ What else is there to do around Seattle while we’re in town?</h2>
            <p>We’re glad you asked! There’s so much to do in the Seattle area, so we highly recommend staying the whole weekend (or longer!). Check out our <strong>Things to Do</strong> page for some ideas to get you started.</p>
            <h2>🎁 Do you have a gift registry?</h2>
            <p>Gifts are NOT expected / necessary; your presence at our party and in our lives is gift enough ❤️ If you’d still like to give a gift of some sort, we’ve given a few ideas on our <strong>Registry</strong> page.</p>
          </article>
        </div>
      </div>
    </div>
